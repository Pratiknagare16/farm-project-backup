document.addEventListener('DOMContentLoaded', () => {
    ...
    diagnoseBtn.addEventListener('click', async () => {
      ...
      if (!selectedFile && !queryText) {
        alert(t('pestDetection.alertNoInput', 'Please provide an image or a description of the issue.'))
        return
      }
      ...
      const analyzingText = t('pestDetection.analyzing', 'Krishi AI is analyzing your crop...');
      const subtext = t('pestDetection.analyzingSubtext', 'This may take a moment');
      ...
      try {
        ...
        if (data.advice) {
          ...
          throw new Error(data.error || t('pestDetection.analysisFailed', 'Analysis failed'))
        }
      } catch (error) {
        console.error('Fetch error:', error)
        const errorText = t('pestDetection.error', 'Error: ');
        const tryAgainText = t('pestDetection.tryAgain', 'Try Again');
    ...
    const diagnosisTitle = t('pestDetection.diagnosisTitle', '🌿 Krishi AI Diagnosis');
